  ...
  return (
    <div className={`albums-swiper-wrapper relative group/nav transition-opacity duration-300 ${ready ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <button
        ...
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1 md:-translate-x-3 z-10 w-9 h-9 md:w-12 md:h-12 rounded-full bg-slate-800/90 backdrop-blur-sm border border-slate-700 flex items-center justify-center text-slate-300 hover:bg-primary hover:text-white hover:border-primary shadow-lg opacity-70 md:opacity-0 group-hover/nav:opacity-100 active:bg-primary active:text-white active:scale-90 transition-all duration-300 cursor-pointer"
        aria-label="Previous"
      >
      ...
      <button
        ...
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1 md:translate-x-3 z-10 w-9 h-9 md:w-12 md:h-12 rounded-full bg-slate-800/90 backdrop-blur-sm border border-slate-700 flex items-center justify-center text-slate-300 hover:bg-primary hover:text-white hover:border-primary shadow-lg opacity-70 md:opacity-0 group-hover/nav:opacity-100 active:bg-primary active:text-white active:scale-90 transition-all duration-300 cursor-pointer"
        aria-label="Next"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
